...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CQRayTrace_t, stringdata) + ofs \
...
const QMetaObject CQRayTrace::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_CQRayTrace.data,
      qt_meta_data_CQRayTrace,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CQRayTrace.stringdata))
